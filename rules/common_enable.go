...
func (s CommonEnable) Exec(req *mof.ReqContext, res *mof.ResContext) error {
	if req.ID == "" {
...
func (s CommonEnable) GetRule() mof.RuleRegister {
	return mof.RuleRegister{Code: "enable", Domain: "common"}
}
